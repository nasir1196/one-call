                        ...
                        <Grid item xs={12} md={6}>
                            <Box sx={{ display: { md: "flex", xs: "initial" }, }}>
                                <Box sx={{ height: "5rem", width: "5rem", borderRadius: "50%", backgroundColor: "#007AFF", m: "0.9rem", display: { md: "block", xs: "none" }, }}>
                                    <a href={`tel:+96566515342`}><Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", m: "15px auto" }}>
                                        <CallOutlinedIcon sx={{ color: "#FFFFFF", fontSize: "3.4rem" }} />
                                    </Box></a>
                                </Box>

                                <Box sx={{ cursor: "pointer" }}>
                                    <Typography sx={{ color: "#FFFFFF", fontWeight: { md: "bolder", xs: "bold" }, fontSize: { md: "2rem", xs: "1.5rem" }, "&:hover": { color: "#007AFF" } }}><a href={`tel:+96566515342`}>Book Online or Call</a></Typography>
