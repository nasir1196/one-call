        ...
        <Box>
            ...
            <Box sx={ { height: { md: "60vh" }, backgroundColor: "#007AFF" } }>
                <Box sx={ { textAlign: "center", color: "#FFFFFF", p: { xs: "2rem", md: "5rem" } } }>
                    ...
                    <Box>
                        <Button variant="contained" sx={ { py: "1rem", px: { xs: "1.5rem", md: "3rem" }, m: "0.8rem", backgroundColor: "#041B34", color: "#FFFFFF", "&:hover": { backgroundColor: "#F7BF23", color: '#041B34' } } }>{ <MoreTimeIcon /> } REQUEST A CALL</Button>
                        <Button variant="contained" sx={ { py: "1rem", px: { xs: "1.5rem", md: "3rem" }, m: "0.8rem", backgroundColor: "#F7BF23", color: "#041B34", "&:hover": { backgroundColor: "#041B34", color: '#FFFFFF' } } }>{ <TtyIcon /> } +120 012 668</Button>
                    </Box>
                </Box>
            </Box>
        </Box>
